...
std::ostream &operator<<(std::ostream &out, Operator binary_operator) {
  switch (binary_operator) {
    ...
    case Operator::Division: out << "/"; break;
    case Operator::Dot: out << "."; break;
    case Operator::Equal: out << "=="; break;
    case Operator::GreaterThan: out << ">"; break;
    case Operator::GreaterThanOrEqual: out << ">="; break;
    case Operator::LessThan: out << "<"; break;
    case Operator::LessThanOrEqual: out << "<="; break;
    case Operator::NotEqual: out << "!="; break;
    case Operator::Minus: out << "-"; break;
    case Operator::Multiplication: out << "*"; break;
