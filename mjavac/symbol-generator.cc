...
#include "mjavac/nodes/program-node.hpp"
...
void generate_symbols_for_statement(SymbolTable *symbol_table, const Node *statement_node, const MethodDeclarationNode *method_node) {
  ...
  // const auto &conditionalNode = static_cast<mjavac::nodes::ConditionalNode *>(statementNode);
  ...
  // const auto &variableNode = static_cast<mjavac::nodes::VariableDeclarationNode *>(statementNode);
